    ...
    return createTheme({
        palette: {
            ...
            grey: {
                50: colors.grey50,
                100: colors.grey100,
                400: mode === ThemeMode.DARK ? colors.grey400 : colors.grey400,
                500: mode === ThemeMode.DARK ? colors.grey500 : colors.grey500,
                600: mode === ThemeMode.DARK ? colors.grey600 : colors.grey600,
                700: mode === ThemeMode.DARK ? colors.grey700 : colors.grey700,
                900: mode === ThemeMode.DARK ? colors.grey900 : colors.grey900
            },
            dark: {
