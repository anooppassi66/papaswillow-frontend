        ...
        <>
            {!isHorizontal ? (
                <>
                    ...
                    >
                        ...
                        {openMini || open ? (
                            ...
                            <IconChevronDown stroke={1.5} size="16px" style={{ marginTop: 'auto', color: '#000', marginBottom: 'auto' }} />
                        )}
                ...
                <ListItemButton
                    ...
                    sx={{ borderBottom: '1px solid #191919',
                        '&.Mui-selected':{ background:'none !important'}
                     }}
                >
                    {/* {menuIcon && <ListItemIcon sx={{ my: 'auto', minWidth: !menu.icon ? 18 : 36 }}>{menuIcon}</ListItemIcon>} */}
                    <ListItemText
                        sx={{ borderBottom: '1px solid #0000' }}
                        primary={
                            <Typography
                                className="submenu"
                                variant={isSelected ? 'h5' : 'body1'}
                                color="inherit"
                                sx={{ my: 'auto', fontSize: '14px', fontWeight: '600', textTransform:'uppercase', }}
                            >
                                {menu.title}
                            </Typography>
                        }
